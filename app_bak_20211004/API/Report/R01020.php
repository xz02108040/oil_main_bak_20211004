...
class R01020 extends JsonApi
{
    ...
    public function toShow() {
        ...
        $this->b_factory_id     = (isset($jsonObj->b_factory_id) && $jsonObj->b_factory_id)?  $jsonObj->b_factory_id : 0;  //
        $this->aproc            = (isset($jsonObj->mode) && $jsonObj->mode)?  $jsonObj->mode : 'A';  //
        //授權來源
        if($token == $this->token)
        {
            $this->errCode = '';
    ...
    public function genReplyAry()
    {
        ...
        {
            //回傳內容
            $ret['amt']   =  wp_work::getAmt($this->b_factory_id,$this->aproc);
        }
        //執行時間
