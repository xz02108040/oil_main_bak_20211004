...
/**
 * R01026
 *　[總廠]施工地點 施工中的工作許可證，施工中
 */
class R01026 extends JsonApi
{
    ...
    public function toShow() {
        ...
        if(is_string($this->b_factory_b_id) && $this->b_factory_b_id != "0") $this->b_factory_b_id = explode(',',$this->b_factory_b_id);
        //授權來源
        if($token == $this->token && $this->b_factory_b_id)
        {
            $this->errCode = '';
            $this->reply = 'Y';
        } else {
    ...
    public function genReplyAry()
    {
        ...
        {
            //回傳內容
            $reptAry        =  $this->genPermitReptToday4($this->b_factory_b_id,$this->searchid);
            $ret['data']    =  $reptAry;
