 ...
 *　違規
 */
class R01030 extends JsonApi
{
    use DoorTrait,ReptPermitTrait,ViolationContractorTrait;
    ...
    public function genReplyAry()
    {
        ...
        if($this->reply == 'Y')
        {
            ...
            $search = [0,0,0,0,0];
            //回傳內容
            $ret['total_men']   = e_violation_contractor::getViolationAmt($today);
            $ret['total_car']   = 0;
            $ret['data']        = $this->getApiViolationContractorTodayList($search);
