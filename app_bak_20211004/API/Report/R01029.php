...
class R01029 extends JsonApi
{
    ...
    public function toShow() {
        ...
        if(is_string($this->b_factory_id) && $this->b_factory_id != "0") $this->b_factory_id = explode(',',$this->b_factory_id);
    ...
    public function genReplyAry()
    {
        ...
        {
            //回傳內容
            $reptAry        =  $this->genPermitReptToday7($this->b_factory_id,$this->b_factory_a_id);
            $ret['amt']     =  count($reptAry);
            $ret['data']    =  $reptAry;
