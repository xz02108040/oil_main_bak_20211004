...
use UUID;
/**
 * D002130 [工作許可證]-工單轉單申請單.
 * 目的：取得 轉單工單申請單.
 *
 */
class D002130 extends JsonApi
{
    ...
    public function toShow() {
        ...
        if(isset($jsonObj->token))
        {
            ...
            $this->project_id   = (isset($jsonData[0]->project_id))?    $jsonData[0]->project_id : ''; //ＴＯＫＥＮ
            $this->work_id      = (isset($jsonData[0]->work_id))?       $jsonData[0]->work_id : ''; //ＴＯＫＥＮ
            $this->work_id2     = (isset($jsonData[0]->work_id2))?      $jsonData[0]->work_id2 : ''; //ＴＯＫＥＮ
            $this->aproc        = (isset($jsonData[0]->aproc))?         $jsonData[0]->aproc : ''; //ＴＯＫＥＮ
            $this->date         = (isset($jsonData[0]->date))?          $jsonData[0]->date : ''; //ＴＯＫＥＮ
    ...
    public function genReplyAry()
    {
        ...
        if($this->reply == 'Y')
        {
            ...
            //目前階段狀態
            $ret['data']  = $this->getApiWorkRPTranUserTraitList($b_supply_id,$this->project_id,$b_dept_id,$this->work_id,$this->work_id2,$this->aproc,$this->date);
