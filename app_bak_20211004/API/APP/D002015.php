        ...
        if(isset($jsonObj->token))
        {
            ...
            if($isSuc == 'Y')
            {
                ...
                elseif(isset($this->bc_type))
                {
                    ...
                    elseif($list_aproc != 'R' && !$this->setApiWorkPermitTopicRecord($this->myTarget,$this->work_id,$list_id,$this->work_process_id,$this->process_id,$this->ans,'Y','N',$this->b_cust_id))
                    {
                        $this->errCode  = 'E00200225';// 請填寫完整資料
                    }
                    elseif($this->setApiWorkPermitTopicRecord($this->myTarget,$this->work_id,$list_id,$this->work_process_id,$this->process_id,$this->ans,'N','N',$this->b_cust_id))
                    {
                        $this->reply     = 'Y';
                        $this->errCode   = '';
                    } else {
