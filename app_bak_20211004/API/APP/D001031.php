...
class D001031 extends JsonApi
{
    ...
    public function genReplyAry()
    {
        ...
        if($this->reply == 'Y')
        {
            ...
            $search = [$this->b_supply_id,$this->violation,$this->sdate,$this->edate,0,$this->law,$this->punish,''];
            $ret['data'] = $this->getApiViolationContractorList($search,2,1);
