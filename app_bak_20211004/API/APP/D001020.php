 ...
 *
 */
class D001020 extends JsonApi
{
    use BcustTrait,SupplyTrait,SupplyMemberTrait,SupplyMemberIdentityTrait,SupplyMemberLicenseTrait,TraningMemberTrait;
    use EngineeringTrait,EngineeringCarTrait,EngineeringHistoryTrait;
    use EngineeringDeptTrait,EngineeringFactoryTrait,EngineeringMemberTrait;
    /**
     * 顯示 回傳內容
     * @return json
     */
    public function toShow() {
        ...
        if(isset($jsonObj->token))
        {
            ...
            $this->supply_name  = (isset($jsonObj->supply_name))? $jsonObj->supply_name : '';
    ...
    public function genReplyAry()
    {
        ...
        if($this->reply == 'Y')
        {
            ...
            //職員
                ...
                $this->supply_id = e_project::getSupply($this->project_id);
            }
            $ret['data'] = $this->getApiSupplyData($this->supply_id,$this->supply_name,'Y');
