...
class wp_work_check_record1 extends Model
{
    /**
     * 使用者Table:
     */
    protected $table = 'wp_work_check_record1';
    /**
     * Table Index:
     */
    ...
    //是否存在
    protected  function isExist($work_id)
    {
        if(!$work_id) return 0;
        $data = wp_work_check_record1::where('wp_work_id',$work_id);
        $data = $data->first();
