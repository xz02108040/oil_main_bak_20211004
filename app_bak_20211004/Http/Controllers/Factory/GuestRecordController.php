...
class GuestRecordController extends Controller
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        //路由
        $this->hrefHome         = '/';
        $this->hrefMain         = 'guest_record';
        $this->langText         = 'sys_base';

        $this->hrefMainDetail   = 'guest_record/';
        $this->hrefMainNew      = 'new_guest_record';
        $this->routerPost       = 'postGuestRecord';

        $this->pageTitleMain    = Lang::get($this->langText.'.base_30322');//大標題
...
//        $btnBack  = $this->pageBackBtn;
        ...
        //-------------------------------------------//
        //抓取資料
        $listAry = $this->getApiGuestList($bid,$sdate,$aid);
...
//        $form->addHr();
        ...
        $html.= $form->select('bid',$storeAry,$bid,2,Lang::get($this->langText.'.base_40106'));
        ...
        $heads[] = ['title'=>Lang::get($this->langText.'.base_40106')]; //拜訪日期
        ...
        if(count($listAry))
        {
            foreach($listAry as $value)
            {
                ...
                $name7        = isset($storeAry[$value->b_factory_id])? $storeAry[$value->b_factory_id] : ''; //
                $name8        = $value->guest_no; //
