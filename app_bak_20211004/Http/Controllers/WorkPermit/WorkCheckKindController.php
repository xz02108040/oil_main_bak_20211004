...
class WorkCheckKindController extends Controller
{
    use WorkCheckKindTrait,SessTraits;
    /*
    |--------------------------------------------------------------------------
    | WorkCheckKindController
    |--------------------------------------------------------------------------
    |
    | 檢點單 種類維護
    |
    */
    ...
    public function __construct()
    {
        ...
        //路由
        $this->hrefHome         = '/';
        $this->hrefMain         = 'workcheckkind';
        $this->hrefTopic        = 'workcheckkindfile';
        $this->langText         = 'sys_workpermit';

        $this->hrefMainDetail   = 'workcheckkind/';
        $this->hrefMainNew      = 'new_workcheckkind';
        $this->routerPost       = 'postWorkcheckkind';
...
//        $btnBack  = $this->pageBackBtn;
        ...
        //-------------------------------------------//
        //抓取資料
        $listAry = $this->getApiWorkCheckKindList();
        ...
        //標題
        $heads[] = ['title'=>'NO'];
        $heads[] = ['title'=>Lang::get($this->langText.'.permit_59')]; //名稱
    ...
    public function show(Request $request,$urlid)
    {
        ...
        $form->add('nameT1', $html,Lang::get($this->langText.'.permit_59'),1);
        //排序
    ...
    public function post(Request $request)
    {
        ...
        if($isNew)
        {
            $ret = $this->createWorkCheckKind($upAry,$this->b_cust_id);
            $id  = $ret;
        } else {
            //修改
            $ret = $this->setWorkCheckKind($id,$upAry,$this->b_cust_id);
        }
        //2-1. 更新成功
        if($ret)
        {
