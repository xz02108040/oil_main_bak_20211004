...
{
    use CourseTypeTrait,SessTraits;
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function __construct(Request $request)
    {
        ...
        //路由
        $this->hrefHome         = '/';
        $this->hrefMain         = 'ecoursetype';
        $this->langText         = 'sys_engineering';

        $this->hrefMainDetail   = 'ecoursetype/';
        $this->hrefMainNew      = 'new_ecoursetype';
        $this->routerPost       = 'postECoursetype';
...
//        $btnBack  = $this->pageBackBtn;
        ...
        //-------------------------------------------//
        //抓取資料
        $listAry = $this->getApiCourseTypeList();
    ...
    public function post(Request $request)
    {
        ...
        if($isNew)
        {
            $ret = $this->createCourseType($upAry,$this->b_cust_id);
            $id  = $ret;
        } else {
            //修改
            $ret = $this->setCourseType($id,$upAry,$this->b_cust_id);
        }
        //2-1. 更新成功
        if($ret)
        {
            ...
            if($ret === -1)
            {
                ...
                //動作紀錄
                LogLib::putLogAction($this->b_cust_id,$menu,$ip,$action,'et_course_type',$id);
