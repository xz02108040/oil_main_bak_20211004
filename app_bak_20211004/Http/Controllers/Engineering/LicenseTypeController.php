...
{
    use LicenseTypeTrait,SessTraits;
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function __construct(Request $request)
    {
        ...
        //路由
        $this->hrefHome         = '/';
        $this->hrefMain         = 'elicensetype';
        $this->langText         = 'sys_engineering';

        $this->hrefMainDetail   = 'elicensetype/';
        $this->hrefMainNew      = 'new_elicensetype';
        $this->routerPost       = 'postELicenseType';
...
//        $btnBack  = $this->pageBackBtn;
        ...
        //-------------------------------------------//
        //抓取資料
        $listAry = $this->getApiLicenseTypeList();
    ...
    public function post(Request $request)
    {
        ...
        if($isNew)
        {
            $ret = $this->createLicenseType($upAry,$this->b_cust_id);
            $id  = $ret;
        } else {
            //修改
            $ret = $this->setLicenseType($id,$upAry,$this->b_cust_id);
        }
        //2-1. 更新成功
        if($ret)
        {
            ...
            if($ret === -1)
            {
                ...
                //動作紀錄
                LogLib::putLogAction($this->b_cust_id,$menu,$ip,$action,'e_license_type',$id);
