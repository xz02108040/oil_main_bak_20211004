...
{
    use EngineeringTypeTrait,SessTraits;
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function __construct(Request $request)
    {
        ...
        //路由
        $this->hrefHome         = '/';
        $this->hrefMain         = 'engineeringtype';
        $this->langText         = 'sys_engineering';

        $this->hrefMainDetail   = 'engineeringtype/';
        $this->hrefMainNew      = 'new_engineeringtype';
        $this->routerPost       = 'postEngineeringType';
...
//        $btnBack  = $this->pageBackBtn;
        ...
        //-------------------------------------------//
        //抓取資料
        $listAry = $this->getApiEngineeringTypeList();
    ...
    public function post(Request $request)
    {
        ...
        if($isNew)
        {
            $ret = $this->createEngineeringType($upAry,$this->b_cust_id);
            $id  = $ret;
        } else {
            //修改
            $ret = $this->setEngineeringType($id,$upAry,$this->b_cust_id);
        }
        //2-1. 更新成功
        if($ret)
        {
            ...
            if($ret === -1)
            {
                ...
                //動作紀錄
                LogLib::putLogAction($this->b_cust_id,$menu,$ip,$action,'e_pjoect_type',$id);
