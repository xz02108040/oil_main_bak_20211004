...
{
    use ViolationTypeTrait,SessTraits;
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function __construct(Request $request)
    {
        ...
        //路由
        $this->hrefHome         = '/';
        $this->hrefMain         = 'eviolationtype';
        $this->langText         = 'sys_engineering';

        $this->hrefMainDetail   = 'eviolationtype/';
        $this->hrefMainNew      = 'new_eviolationtype';
        $this->routerPost       = 'postEViolationtype';
...
//        $btnBack  = $this->pageBackBtn;
        ...
        //-------------------------------------------//
        //抓取資料
        $listAry = $this->getApiViolationTypeList();
    ...
    public function post(Request $request)
    {
        ...
        if($isNew)
        {
            $ret = $this->createViolationType($upAry,$this->b_cust_id);
            $id  = $ret;
        } else {
            //修改
            $ret = $this->setViolationType($id,$upAry,$this->b_cust_id);
        }
        //2-1. 更新成功
        if($ret)
        {
            ...
            if($ret === -1)
            {
                ...
                //動作紀錄
                LogLib::putLogAction($this->b_cust_id,$menu,$ip,$action,'e_violation_type',$id);
