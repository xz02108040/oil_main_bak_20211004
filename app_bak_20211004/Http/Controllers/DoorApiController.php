...
class DoorApiController extends Controller
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->ASE = new AESLib();
        //參數
        $this->receiveType      = 0;  //傳送格式：0:否,1:是
...
//            $this->errorReply();
    ...
    public function resolver($jsonData)
    {
        ...
        $className = 'App\\API\\Door\\' . $funcode;
        $classPath = app_path().'/API/Door/' . $funcode . '.php';
        //3. 確認「格式代碼」 是否存在
