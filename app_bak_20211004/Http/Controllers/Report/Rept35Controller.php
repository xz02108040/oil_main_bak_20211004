...
class Rept35Controller extends Controller
{
    use SessTraits;
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function __construct()
    {
        ...
        //路由
        $this->hrefHome         = '/';
        $this->hrefMain         = 'report_35';

        $this->pageTitleMain    = '工作許可證巡邏會簽【部門】排行版';//大標題
...
//        if(!$aid || !$bid)
        {
            ...
            $SQL = "SELECT D.name,COUNT(*) 巡邏會簽次數 FROM dbo.wp_work_check_topic A
