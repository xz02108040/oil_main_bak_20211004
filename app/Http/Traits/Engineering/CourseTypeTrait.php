...
trait CourseTypeTrait
{
     ...
     * @return bool
     */
    public function createCourseType($data,$mod_user = 1)
    {
        $ret = false;
     ...
     * @return bool
     */
    public function setCourseType($id,$data,$mod_user = 1)
    {
        $ret = false;
     ...
     * @return array
     */
    public function getApiCourseTypeList()
    {
        $ret = array();
        //取第一層
        $data = et_course_type::orderby('isClose')->orderby('show_order')->get();
