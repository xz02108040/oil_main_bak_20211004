...
trait LicenseTypeTrait
{
     ...
     * @return bool
     */
    public function createLicenseType($data,$mod_user = 1)
    {
        $ret = false;
     ...
     * @return bool
     */
    public function setLicenseType($id,$data,$mod_user = 1)
    {
        $ret = false;
     ...
     * @return array
     */
    public function getApiLicenseTypeList()
    {
        $ret = array();
        //取第一層
        $data = e_license_type::orderby('isClose')->orderby('show_order')->get();
