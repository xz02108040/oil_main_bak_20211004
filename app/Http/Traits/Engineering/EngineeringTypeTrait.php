...
trait EngineeringTypeTrait
{
     ...
     * @return bool
     */
    public function createEngineeringType($data,$mod_user = 1)
    {
        $ret = false;
     ...
     * @return bool
     */
    public function setEngineeringType($id,$data,$mod_user = 1)
    {
        $ret = false;
     ...
     * @return array
     */
    public function getApiEngineeringTypeList()
    {
        $ret = array();
        //取第一層
        $data = e_project_type::orderby('isClose')->orderby('show_order')->get();
