...
class Rept20Controller extends Controller
{
    use SessTraits;
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function __construct()
    {
        ...
        //路由
        $this->hrefHome         = '/';
        $this->hrefMain         = 'report_20';

        $this->pageTitleMain    = '工程案件違規事項排行板';//大標題
...
//        if(!$aid || !$bid)
        {
            ...
            $SQL = "SELECT TOP ".$aid." --設定排名資料
                    B.id AS 編號, B.project_no,B.name AS 案件名稱,COUNT(*) 筆數
                    ...
                    WHERE $query
					GROUP BY B.id,B.project_no,B.name
					ORDER BY 筆數 DESC
					";
