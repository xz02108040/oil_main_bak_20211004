...
class Rept15Controller extends Controller
{
    use SessTraits;
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function __construct()
    {
        ...
        //路由
        $this->hrefHome         = '/';
        $this->hrefMain         = 'report_15';

        $this->pageTitleMain    = '承攬商刷卡異常原因排行板';//大標題
...
//        if(!$aid || !$bid)
        {
            ...
            $SQL = "SELECT TOP ".$aid." 
					A.door_memo AS 刷卡異常原因,COUNT(*) AS 筆數 FROM dbo.log_door_inout A
					WHERE A.door_result='N' 
					".$query."
					GROUP BY  A.door_memo
					ORDER BY 筆數 DESC
					";
