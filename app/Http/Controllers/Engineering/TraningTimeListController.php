...
class TraningTimeListController extends Controller
{
    use TraningTimeTrait,SessTraits;
    /*
    |--------------------------------------------------------------------------
    | TraningTimeListController
    |--------------------------------------------------------------------------
    |
    | 課程時段 查詢
    |
    */
    ...
    public function __construct()
    {
        ...
        $this->hrefMain         = 'etraningtimelist';
        $this->langText         = 'sys_engineering';

        $this->hrefMainDetail   = 'etraningtimelist/';
        $this->hrefMainNew      = 'new_etraningtimelist/';
        $this->routerPost       = 'postETraningtimelist';
    ...
    public function index(Request $request)
    {
        ...
        //-------------------------------------------//
        //抓取資料
        $listAry = $this->getApiTraningTimeList($pid,'N');
