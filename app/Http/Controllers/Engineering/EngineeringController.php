...
//        $btnBack  = $this->pageBackBtn;
    ...
    public function show(Request $request,$urlid)
    {
        ...
        if(!isset($getData->id))
        {
            ...
            $A28        = $getData->charge_store_name; //
            $A29        = $getData->charge_store_name2; //
            $A30        = $getData->supply; //
            $A31        = $getData->type; //
...
//            $setLocalBtn1 = HtmlLib::btn($setLocalHref,Lang::get($this->langText.'.'.$setLocalString),$setLocalColor);
        ...
        $form->add('nameT1', $html,Lang::get($this->langText.'.engineering_10'));
        //施工結束時間
        $html = ($isProjectClose)? $A12 : $form->time('etime',$A12);
        $form->add('nameT1', $html,Lang::get($this->langText.'.engineering_11'));
        //說明
