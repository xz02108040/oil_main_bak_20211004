...
class R01004 extends JsonApi
{
    ...
    public function toShow() {
        ...
        $this->b_factory_a_id   = (isset($jsonObj->b_factory_a_id))?  $jsonObj->b_factory_a_id : 0; //帳號
    ...
    public function genReplyAry()
    {
        ...
        {
            //回傳內容
            $ret['data']   = b_factory_b::getApiSelect($this->b_factory_a_id);
