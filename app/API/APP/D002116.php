...
use UUID;
/**
 * D002116 [工作許可證]-工單延長申請單.
 * 目的：取得 延長工單申請單.
 *
 */
class D002116 extends JsonApi
{
    ...
    public function toShow() {
        ...
        if(isset($jsonObj->token))
        {
            ...
            $this->project_id   = (isset($jsonObj->project_id))?    $jsonObj->project_id : ''; //ＴＯＫＥＮ
            $this->work_id      = (isset($jsonObj->work_id))?       $jsonObj->work_id : ''; //ＴＯＫＥＮ
            $this->aproc        = (isset($jsonObj->aproc))?         $jsonObj->aproc : ''; //ＴＯＫＥＮ
            $this->date         = (isset($jsonObj->date))?          $jsonObj->date : ''; //ＴＯＫＥＮ
    ...
    public function genReplyAry()
    {
        ...
        if($this->reply == 'Y')
        {
            ...
            //目前階段狀態
            $ret['data']  = $this->getApiWorkRPExtendedTraitList($b_supply_id,$this->project_id,$b_dept_id,$this->work_id,$this->aproc,$this->date);
